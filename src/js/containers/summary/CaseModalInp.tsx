                                ...
                                <div className="paitent-info">
                                    ...
                                    <span >
                                      ...
                                      { !is_en ?<>于<Calendar width={120} field="fcydata" clickBack={this.setCalendar} selTimeValArr={fcydata} />{config.fcydata}</>: config.fcydata+fcydata}
                                        ，<>{config.fsumd}&nbsp;{!is_en ? <input type="number" className={"s-inp normal " + (!fsumd && "no-fill" || "")} style={{width:60}} name="fsumd" onChange={this.changeHandle} value={fsumd} />: fsumd}&nbsp;{config.fsumd1}</>。</span>
                                </div>
